...
CREATE OR REPLACE FUNCTION "public"."get_session_counts"("session_ids" "uuid"[]) RETURNS TABLE("session_id" "text", "count" bigint)
...
ALTER FUNCTION "public"."get_session_counts"("session_ids" "uuid"[]) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_user_counts"("user_ids" "uuid"[]) RETURNS TABLE("user_id" "text", "count" bigint)
    LANGUAGE "sql" SECURITY DEFINER
    AS $$
...
ALTER FUNCTION "public"."get_user_counts"("user_ids" "uuid"[]) OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."events" (
    ...
    "default_description" "jsonb" DEFAULT '{}'::"jsonb",
...
GRANT ALL ON FUNCTION "public"."get_session_counts"("session_ids" "uuid"[]) TO "anon";
GRANT ALL ON FUNCTION "public"."get_session_counts"("session_ids" "uuid"[]) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_session_counts"("session_ids" "uuid"[]) TO "service_role";



GRANT ALL ON FUNCTION "public"."get_user_counts"("user_ids" "uuid"[]) TO "anon";
GRANT ALL ON FUNCTION "public"."get_user_counts"("user_ids" "uuid"[]) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_user_counts"("user_ids" "uuid"[]) TO "service_role";
